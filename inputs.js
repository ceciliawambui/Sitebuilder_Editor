...
var CssUnitRangeInput = $.extend({}, Input, {
	...
	onChange: function(event) {
		...
		$('#m-right').html(value);
		$('#m-top').html(value);
		$('#max-height').html(value);
		$('#max-width').html(value);
		$('#min-height').html(value);
		$('#min-width').html(value);
		$('#size-height').html(value);
		$('#size-width').html(value);
		$('#display-top').html(value);
		$('#display-left').html(value);
		$('#display-right').html(value);
		$('#display-bottom').html(value);
	},
	...
	init: function(data) {
		return this.render("CssUnitRangeInput", data);
	},
  }
);
